 ...
 * printing each number (including 0 and 10).
 */
 ...
 *
 * Create a loop 
 * that prints every even number 
 * BETWEEN 0 and 100 (not including 0 or 100).
 */
function prompt2(){
  for (let i = 0; i <100; i++){
    if (i>0 && i%2 === 0){
...
var someNumber = Math.floor(Math.random() * 99);
function prompt8() {
  if (someNumber < 30) {
 ...
 */
    ...
    //function prompt9() {
      //const starWars = ["Han", "C3PO", "R2D2"]{
        //console.log(i + ",");}
    

  
    function prompt9() {
      const starWars = ["Han", "C3PO", "R2D2", "Luke", "Leia"];
 ...
 *
 * Write a loop 
 * that pushes every even number between 0 and 100 
 * into an array,
 ...
 * The median number is the middle number in a SORTED list of numbers. Think through the steps you'll need to take to determine this number with code!
 *
